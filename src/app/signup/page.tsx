        ...
        <div className="mt-8">
          ...
          <div className="grid grid-cols-3 gap-3">
            <button 
              ...
              className="flex items-center justify-center bg-white/5 border border-white/10 hover:bg-white/10 p-3 rounded-lg transition-colors group"
            >
            ...
            <button 
              ...
              className="flex items-center justify-center bg-white/5 border border-white/10 hover:bg-white/10 p-3 rounded-lg transition-colors text-white"
            >
